{include file="head.tpl" cssfile="hexenjagd" title="Hexenjagd von Arthur Miller"}
	<div class="info">
		...
		<p>Brave Gemeindemitglieder beginnen in der allgemein einsetzenden Hysterie sich gegenseitig zu beschuldigen. Ganz Salem wird zu einem brodelnden Hexenkessel des Aberglaubens und der Denunziation. Das einberufene Gericht, selbst im eigenen Machtdenken und Aberglauben befangen, soll nun die Wahrheit herausfinden und Recht sprechen.</p>
